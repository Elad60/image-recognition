const cognitoConfig = {
    UserPoolId: 'us-east-1uyygihpki',
    ClientId: '41i51mrsattsmbtr11f76i2rgq',
    Domain: 'us-east-1uyygihpki',
    ClientSecret: '1830vcq3ndhpl52hqcj1gjmc42eaapsj0bvholc489undibh5d8b',
    Region: 'us-east-1',
...
function signIn() {
    const url = `https://${cognitoConfig.Domain}.auth.${cognitoConfig.Region}.amazoncognito.com/login?client_id=${cognitoConfig.ClientId}&response_type=code&scope=email+openid+phone&redirect_uri=${encodeURIComponent(cognitoConfig.redirectUri)}`;
